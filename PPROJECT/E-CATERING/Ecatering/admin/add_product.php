...
<section class="section">
  <div class="row">
    <div class="col-lg-8">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Add food Products here</h5>
          ...
          <div class="row mb-3">
            ...
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-5 col-form-label">Select Subcategory</label>
              <div class="col-sm-7">
                <select  name="subcatname"  placeholder="Food main Category" class="form-control" id="inputText" data-bvalidator="required">
          ...
          <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-5 col-form-label">Food products Name</label>
              <div class="col-sm-7">
                <input type="text" name="pname" data-bvalidator="required,alpha" placeholder="Food Product Name" class="form-control" id="inputText">
              </div>
            </div>
          ...
          <div class="row mb-3">
              ...
              <div class="col-sm-7">
                <input type="file" name="pimg" data-bvalidator="required" placeholder="Food Sub Category" class="form-control" id="inputText">
              </div>
            </div>
