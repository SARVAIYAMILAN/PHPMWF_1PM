    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="card">`
            <div class="card-body">
              <h5 class="card-title">Add food Category here </h5>

              <!-- Horizontal Form -->
              <form method="post" id="frm1">
                <div class="row mb-3">
                  <label for="inputEmail3" class="col-sm-5 col-form-label">food Category Name</label>
                  <div class="col-sm-7">
                ...
                <div class="text-center">
                  <button type="submit" name="addcat" class="btn btn-primary">Add food Category</button>
