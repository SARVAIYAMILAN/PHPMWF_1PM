        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="<?php echo $row["image"]; ?>" style="height:200px; width:200px;" alt="Profile" ><br>
                  ...
                  <form method="post">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="<?php echo $row["image"]; ?>" style="height:200px; width:200px;" alt="Profile">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" class="form-control" value="<?php echo $row["name"]; ?>" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="phone" class="form-control" value="<?php echo $row["phone"]; ?>" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" class="form-control" value="<?php echo $row["email"]; ?>" required>
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="npass" type="password" class="form-control"required>
                      </div>
                    </div>
